...
func calculateInTier(c character, slot int, phase int, slotItems []shared.Loot, allItemsByPhase keyedLoot) bool {
...
func getEligibleLoot(phase int, slotItems []shared.Loot, itemsByPhase keyedLoot) []*shared.Loot {
	items := []*shared.Loot{}
